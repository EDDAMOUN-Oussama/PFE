      ...
      <div className="hidden lg:block lg:w-1/2 bg-gradient-to-r from-purple-400 to-indigo-600">
        <div className="flex h-full items-center justify-center p-12">
          <div className="max-w-lg">
            <h1 className="text-4xl font-bold text-white mb-6">HealthyTrack</h1>
            <p className="text-white/80 text-lg">
              Your personal health companion. Track your weight, nutrition, and exercises to reach your health goals.
            </p>
          </div>
        </div>
      </div>
